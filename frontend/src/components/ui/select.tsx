...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-cartex-surface border-cartex text-cartex placeholder:text-cartex-muted',
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-cartex-muted" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-[color-mix(in_srgb,var(--cartex-border)_50%,transparent)]',
      className
    )}
    {...props}
  >
