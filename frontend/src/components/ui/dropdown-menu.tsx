...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-[color-mix(in_srgb,var(--cartex-border)_50%,transparent)] data-[state=open]:bg-[color-mix(in_srgb,var(--cartex-border)_50%,transparent)]',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      'bg-cartex-card border-cartex text-cartex',
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-[color-mix(in_srgb,var(--cartex-border)_50%,transparent)] focus:text-cartex',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-cartex-border', className)}
    {...props}
  />
));
